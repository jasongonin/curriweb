...
import pw.jgo.curriculumweb.config.audit.AuditEventConverter;
import pw.jgo.curriculumweb.domain.PersistentAuditEvent;
...
import static pw.jgo.curriculumweb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
